  ...
  return (
    <div className="p-3  lg:pl-24">
      <div className="flex justify-center items-center flex-col">
        ...
        <p className="text-2xl mt-10 font-bold text-blue-800">
          Ready to Join Our Class?
        </p>
        <p className="text-base leading-tight mt-5 mb-12 text-center text-gray-800">
          Mari bergabung dengan kami dan akses jendela ilmu <br /> yang akan
          membantu masa depan Anda.
        </p>
        <BtnFullRound
          color="blue-600"
